...
// ANSWER:  If you are never going to go past the 4th element then just do numbers[3] to get back to a constant factor but if greater than the 4th element then no because after the 4th element O(1) becomes the most efficient time complexitiy.
...
//This is a true O(n)instead of an O(3n)
...
// ANSWER: I didn't see any nested arrays within an array but each function takes in an array so that means each one has to be O(n)
